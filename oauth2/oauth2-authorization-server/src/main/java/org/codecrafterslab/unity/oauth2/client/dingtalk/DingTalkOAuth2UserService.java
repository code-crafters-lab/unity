...
@Slf4j
@Component
public class DingTalkOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, DingTalkOAuth2User> {
...
//        return null;
        ...
        RequestEntity<?> request = this.dingTalkConvert(userRequest);
    ...
    private ResponseEntity<Map<String, Object>> getResponse(OAuth2UserRequest userRequest, RequestEntity<?> request) {
        try {
            ...
            String errorMessage = "An error occurred while attempting to retrieve the UserInfo Resource from '"
                    ...
                    + "that contains a collection of name and value pairs of the claims about the authenticated " +
                    "End-User. "
                    + "Please ensure the UserInfo Uri in UserInfoEndpoint for Client Registration '"
                    + userRequest.getClientRegistration().getRegistrationId() + "' conforms to the UserInfo Endpoint, "
                    + "as defined in OpenID Connect 1.0: 'https://openid.net/specs/openid-connect-core-1_0" +
                    ".html#UserInfo'";
